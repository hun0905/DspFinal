...
import numpy as np
import cv2
from ImgSeg4 import getFood
import csv
from Shape import getShapeFeatures
import pprint
def nutrtion_dict(food):
    with open('/home/huan/Desktop/DspFinal/density_calorie.csv', 'r') as nutrition:
...
img=cv2.imread('/home/huan/Desktop/DspFinal/FooDD/Mixed/5-CanonSD-1400-Light Environment/5 (2).JPG', cv2.IMREAD_COLOR)
# img=cv2.imread('/home/huan/Desktop/DspFinal/FruitPlate/11.jpg', cv2.IMREAD_COLOR)
# img=cv2.imread('/home/huan/Desktop/DspFinal/FruitPlate/11.jpg', cv2.IMREAD_COLOR)

img =  cv2.resize(img, (512, 512))
classifier = pickle.load(open('/home/huan/Desktop/DspFinal/FoodClassifier_best.pkl', 'rb'))
scaler = pickle.load(open('/home/huan/Desktop/DspFinal/scaler_best.pkl', 'rb'))
print('照片中有多少種食物? ')
